...
function Payment() {
    ...
    const handlePayment = async (e) => {
        ...
        try {
            ...
            const clientSecret = response.data.client_secret || response.data.clientSecret;
            ...
            if (!clientSecret) {
                console.error("No client secret in response. Full response:", response.data);
                throw new Error("No client secret received. Check backend response format.");
            }
            ...
            console.log("Step 7: Stripe confirmation result:", { paymentIntent, error });
